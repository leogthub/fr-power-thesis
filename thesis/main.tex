...
\usepackage[
  ...
  urlcolor=accent,
  bookmarks=true,
  pdfauthor={Leo Camberleng and Lyam Oumedjeber},
...
% ── Code attachment (top of document) ────────────────────────
\thispagestyle{empty}
\vspace*{0.5cm}
\noindent\fbox{%
  \parbox{\textwidth}{%
    \centering
    \textbf{Source Code Appendix} \quad
    \textattachfile[
      color=0 0.31 0.49,
      mimetype=application/pdf,
      description={Source Code — FR Power Thesis (Python, 62 pages)}
    ]{code_appendix.pdf}{\textcolor{accent}{\underline{Click here to open Code\_Appendix.pdf}}}
    \quad (embedded PDF, 62 pages)
  }%
}
\vspace{0.5cm}
\clearpage
...
maximum drawdown ten times smaller than the na\"{i}ve strategy.
