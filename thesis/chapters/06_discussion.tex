...
temperature forecasts \citep{rte2024}. When we include this load forecast in
...
commodity market. This indirect transmission channel is consistent with the
literature on weather-adjusted fuel prices \citep{lindberg2019}: commodity
...
with higher renewable penetration. In Germany, wind and solar represent over
50\% of generation, and the direct impact of weather on supply is much larger.
