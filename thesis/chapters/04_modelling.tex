...
approximately 20.7\% of total MDI importance — the single most informative
feature — followed by the 24-hour rolling mean (14.3\%), 48-hour lag (12.4\%),
168-hour rolling mean (11.9\%), and 168-hour lag (10.4\%). Collectively, price
lags and rolling means account for nearly 70\% of total importance. The primacy
...
The 168-hour lag captures weekly seasonality but ranks fifth, suggesting that
recent price context (rolling means and the 48-hour anchor) carries more
information than the specific weekly price level.

Among fundamental variables, TTF natural gas price (8.3\%) and ARA coal
...
ratio ($\approx$1.9\%) also appears among the top features, consistent with
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{model_comparison_2022_vs_2024.png}
  \caption{Model performance across the two test regimes: 2022 energy crisis
    (red) vs.\ 2024--25 stable period (blue). Left: MAE (EUR/MWh); right:
    R$^2$. The DM test for weather contribution (C vs B) switches from
    non-significant ($p=0.572$) in the stable period to highly significant
    ($p<0.001$) in the crisis, confirming the regime-dependence of the
    weather effect.}
  \label{fig:comparison_2022}
\end{figure}
